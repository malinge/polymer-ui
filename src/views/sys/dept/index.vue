<template>
	<el-card>
		<el-form :inline="true">
			<el-form-item>
				<el-button v-auth="'sys:dept:save'" type="primary" @click="addOrUpdateHandle(false, null)">新增</el-button>
			</el-form-item>
			<el-form-item>
      ...
      <el-table-column prop="createTime" label="创建时间" header-align="center" align="center"></el-table-column>
			<el-table-column label="操作" fixed="right" header-align="center" align="center" width="160">
				<template #default="scope">
					<el-button v-auth="'sys:dept:save'" type="primary" link @click="addOrUpdateHandle(false, scope.row)">新增</el-button>
					<el-button v-auth="'sys:dept:update'" type="primary" link @click="addOrUpdateHandle(true, scope.row)">修改</el-button>
					<el-button v-auth="'sys:dept:delete'" type="primary" link @click="deleteHandle(scope.row.id)">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
